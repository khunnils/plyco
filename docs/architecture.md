...
- vendor inventory is scoped to the route organization, vendors are defined once, and service-specific vendor processing is stored as service-vendor uses managed from each service view
