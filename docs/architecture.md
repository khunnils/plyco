...
Activity-level AI governance answers live on `business_activities`: whether the activity uses AI, free-text AI use cases, whether customer data is used for training or sent to AI providers, whether outputs get human review, and whether users are informed when AI is used.
