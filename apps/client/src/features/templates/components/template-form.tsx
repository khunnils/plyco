    ...
    <form className="grid gap-4" id="template-form" onSubmit={handleSubmit}>
      ...
      >
        ...
        >
          <div className="grid gap-3">
            ...
            <label className="relative block">
              ...
              <input
                className="field-focus-compact h-9 w-full rounded-md border border-slate-200 bg-white pr-3 pl-9 text-sm text-slate-900 transition outline-none"
        ...
        >
          ...
          <textarea
            className="field-focus-compact h-full w-full resize-none overflow-y-auto rounded-md border border-slate-200 bg-white px-3 py-2 font-mono text-sm text-slate-900 transition outline-none"
            ref={textareaRef}
            value={draft.content}
            onChange={(event) =>
              setDraft((current) => ({
