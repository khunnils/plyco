...
const nullableCodeIdSchema = codeIdSchema.or(z.literal("")).nullable().default(null)
const nullableCountryCodeSchema = countryCodeSchema.or(z.literal("")).nullable().default(null)
...
export const servicePrivacyProfileSchema = z.object({
  usesCookies: nullableBooleanSchema,
  cookieTypes: nullableCodeIdArraySchema,
...
export const accessProfileSchema = z.object({
  ...
  privilegedAccessRestricted: nullableBooleanSchema,
...
export const emptyAccessProfile: AccessProfile = {
  ...
  privilegedAccessRestricted: null,
  leastPrivilege: null,
